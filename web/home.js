  ...
  function html() {
    ...
    <div class="wrap">
      ...
      <div class="note">
        ...
        ・鉄道の運行データには、公共交通オープンデータセンターが提供するデータ(JR東日本ほか。JR東日本分は公共交通オープンデータチャレンジ限定ライセンス)を利用しています。情報の正確性・完全性は保証されません。表示内容や操作に関するお問い合わせは、データ提供者ではなく、こちらの<a href="https://github.com/nicchizuofficial-debug/city-pulse/issues" target="_blank" rel="noopener">GitHub Issues</a>へお願いします。
      </div>
    </div>`;
  }
